...
-- -----------------------------------------------------------------------------
insert into public.muscles (code, display_name, display_name_ko, display_order)
values
  ('chest', 'Chest', '가슴', 10),
  ('upper_chest', 'Upper Chest', '상부 가슴', 20),
  ('serratus_anterior', 'Serratus Anterior', '전거근', 30),
  ('front_deltoid', 'Front Deltoid', '전면 삼각근', 40),
  ('lateral_deltoid', 'Lateral Deltoid', '측면 삼각근', 50),
  ('rear_deltoid', 'Rear Deltoid', '후면 삼각근', 60),
  ('upper_trapezius', 'Upper Trapezius', '상부 승모근', 70),
  ('middle_trapezius', 'Middle Trapezius', '중부 승모근', 80),
  ('lower_trapezius', 'Lower Trapezius', '하부 승모근', 90),
  ('lats', 'Latissimus Dorsi', '광배근', 100),
  ('rhomboids', 'Rhomboids', '능형근', 110),
  ('spinal_erectors', 'Spinal Erectors', '척추기립근', 120),
  ('biceps', 'Biceps', '이두근', 130),
  ('triceps', 'Triceps', '삼두근', 140),
  ('forearm_flexors', 'Forearm Flexors', '전완 굴곡근', 150),
  ('forearm_extensors', 'Forearm Extensors', '전완 신전근', 160),
  ('transverse_abdominis', 'Transverse Abdominis', '복횡근', 170),
  ('abs', 'Rectus Abdominis', '복직근', 180),
  ('obliques', 'Obliques', '복사근', 190),
  ('hip_flexors', 'Hip Flexors', '고관절 굴곡근', 200),
  ('glutes', 'Glutes', '둔근', 210),
  ('abductors', 'Hip Abductors', '외전근', 220),
  ('adductors', 'Hip Adductors', '내전근', 230),
  ('quadriceps', 'Quadriceps', '대퇴사두근', 240),
  ('hamstrings', 'Hamstrings', '햄스트링', 250),
  ('calves', 'Calves', '종아리', 260),
  ('tibialis_anterior', 'Tibialis Anterior', '전경골근', 270)
